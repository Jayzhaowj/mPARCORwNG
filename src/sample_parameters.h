...
void sample_beta_tilde(arma::mat& beta_nc_samp, arma::vec& y, arma::mat& x, arma::colvec& theta_sr, arma::vec& sig2, arma::colvec& beta_mean, int N, int d, Function Rchol); //
